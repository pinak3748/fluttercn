...
<Tabs items={['Preview', 'Code']}>
  <Tab value="Preview">
    <MobileScreenshot
      src="/previews/button/button_variants.png"
      alt="Button variants preview"
      width={360}
    />
  </Tab>
  <Tab value="Code">
...
<Tabs items={['Preview', 'Code']}>
  <Tab value="Preview">
    <MobileScreenshot
      src="/previews/button/button_sizes.png"
      alt="Button sizes preview"
      width={360}
    />
  </Tab>
  <Tab value="Code">
...
<Tabs items={['Preview', 'Code']}>
  <Tab value="Preview">
    <MobileScreenshot
      src="/previews/button/button_icons.png"
      alt="Button icons preview"
      width={360}
    />
  </Tab>
  <Tab value="Code">
...
<Tabs items={['Preview', 'Code']}>
  <Tab value="Preview">
    <MobileScreenshot
      src="/previews/button/button_loading.png"
      alt="Button loading state preview"
      width={360}
    />
  </Tab>
  <Tab value="Code">
...
<Tabs items={["Preview", "Code"]}>
  <Tab value="Preview">
    <MobileScreenshot
      src="/previews/button/button_disabled.png"
      alt="Button disabled state preview"
      width={360}
    />
  </Tab>
  <Tab value="Code">
    ```dart Button( onPressed: () {}, disabled: true, child: Text('Disabled'), )
    ```
  </Tab>
</Tabs>
...
<Callout type="info">
  Buttons automatically scale down when pressed and show appropriate cursor on
  hover.
</Callout>
