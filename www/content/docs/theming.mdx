...
<Callout type="warn">
Only modify `initializeTheme` if building custom components that need theme access outside the widget tree. Flutter CN components handle theme changes automatically.
</Callout>
